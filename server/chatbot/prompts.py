...
- Когда упоминаешь экспонат или личность из контекста, сразу добавляй ссылку: например, "[Говорков Алексей Сергеевич](/historical-figures/6) - это..."

Формат ссылок:
- Экспонат: /artifacts/{id}
- Историческая личность: /historical-figures/{id}
- Зал: /halls/{id}
...
def format_historical_figure_context(figures: list) -> str:
    ...
    for figure in figures:
        ...
        lines.append(f"  ССЫЛКА ДЛЯ ОТВЕТА: [\"{full_name}\"](/historical-figures/{figure.get('id')})")
        lines.append("")
